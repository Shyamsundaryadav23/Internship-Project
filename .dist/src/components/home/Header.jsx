  ...
  return (
    ...
    <nav className='header row sticky-top'>
        ...
        <div className='dropdown'>
          ...
          aria-expanded='false'>
            {user.avatar.url && (
              <img src={user.avatar.url} alt="icon" className='user-img rounded-circle w-25 h-25'/>

            )}
            {!user.avatar.url && "account_circle"}
            {/* <img src="/assets/avatar.png" alt="icon" className='user-img rounded-circle w-25 h-25'/> */}
          </span>
